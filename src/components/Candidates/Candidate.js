...
class Candidate extends Component {
  ...
  sortAscending = () => {
    ...
    this.props.profiles.sort((a, b) => {
      return a.publishStatus[0].status > b.publishStatus[0].status
        ? 1
        : b.publishStatus[0].status > a.publishStatus[0].status
          ? -1
          : 0;
    });
    this.setState({
  ...
  sortDescending = () => {
    if (this.props.profiles.length === 0) return null;
    this.props.profiles.sort((a, b) => {
      return b.publishStatus[0].status > a.publishStatus[0].status
        ? 1
        : a.publishStatus[0].status > b.publishStatus[0].status
          ? -1
          : 0;
    });
    this.setState({
